...
function setupShellEvents(root) {
    ...
    root.addEventListener('click', e => {
        ...
        if (tab === 'sistem') {
            ...
            if (p?.dataset['overview'])
                p.innerHTML = p.dataset['overview'];
        }
        root.querySelectorAll('.tab-btn').forEach(b => b.classList.remove('active'));
        root.querySelectorAll('.tab-panel').forEach(p => p.classList.remove('active'));
        root.querySelectorAll('.right-view').forEach(v => v.classList.remove('active'));
        root.querySelectorAll('.left-view').forEach(v => v.classList.remove('active'));
        root.querySelectorAll('.comp-item').forEach(el => el.classList.remove('active'));
        btn.classList.add('active');
        root.querySelector(`[data-panel="${tab}"]`)?.classList.add('active');
        root.querySelector(`[data-right="${tab}"]`)?.classList.add('active');
        const leftKey = tab === 'sistem' ? 'komponen' : 'capaian';
        root.querySelector(`[data-left="${leftKey}"]`)?.classList.add('active');
        root.querySelector('.layout')?.classList.toggle('hide-right', tab === 'evaluasi');
    });
...
function renderSistemDesc(text) {
